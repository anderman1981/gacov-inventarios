...
final class UserController extends Controller
{
    ...
    public function resetPassword(User $user): RedirectResponse
    {
        ...
        $temporaryPassword = bin2hex(random_bytes(6)); // 12 chars hex aleatorio y único
        ...
        return back()->with('success', "Contraseña de «{$user->name}» restablecida. La contraseña temporal es: {$temporaryPassword}");
    }
